    ...
    public class Receiver
    {
        ...
        public void actReceiver(string name)
        {
            ...
            try
            {
                ...
                Console.Write("\n =====================================\n");
                host = CreateChannel<ServerService, IServerService>();
                host.Open();
        ...
        public void actMultipleRecievers(List<string> urls)
        {
            ...
            try
            {
                ...
                using (service.host = new ServiceHost(typeof(ServerService), uriList[0]))
                {
                    int i = 0;
                    foreach (Uri address in uriList)
                    {
                        service.host.AddServiceEndpoint(typeof(IServerService), bindingList[i], address);
                        i++;
                    }
                    service.host.Open();
