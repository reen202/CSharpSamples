...
namespace CodeAnalysis
{
    ...
    public class RelationshipRepository     //holds data to be displayed at parse2
    {
        ...
        public static Dictionary<String, List<ElemRelation>> relDetails = new Dictionary<string, List<ElemRelation>>();
    ...
    public class PushStackRelationship : AAction
    {
        ...
        public void doActionInheritance(CSsemi.CSemiExp semi, string file, ElemRelation elem)
        {
            if (semi[0].Equals("Inheritance"))
            {
                ...
                RelationshipRepository.typeTable.add(elem.fromClass, null, elem.fileName);

                
                if(RelationshipRepository.relDetails.ContainsKey(file)){
                    RelationshipRepository.relDetails[file].Add(elem);
                }
                else
                {
                    RelationshipRepository.relDetails[file] = new List<ElemRelation>();
                    RelationshipRepository.relDetails[file].Add(elem);
                }
