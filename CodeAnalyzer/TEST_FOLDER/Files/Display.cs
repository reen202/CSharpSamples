...
namespace CodeAnalysis
{
    public class Display
    {
        ...
        public void displayFileInfoComplexity(AnalyzerOutput analyzerOutput)
        {
            ...
            Console.Write("\n ----------------------------\n");
            Console.WriteLine("Displaying Code Analysis Results\n");
            ...
            if (null != analyzerOutput.complexityAnalysis)
            {
                ...
                {
                    if (null == analyzerOutput.complexityAnalysis.fileComplexityList || analyzerOutput.complexityAnalysis.fileComplexityList.Count == 0)
                    {
                            ...
                            if (null != ns.elementList && ns.elementList.Count > 0)
                            {
                                ...
                                foreach (ElementInfo elem in ns.elementList)
                                {
                                    ...
                                    if (null != elem.functionsList && elem.functionsList.Count > 0)
                                    {
                                        ...
                                        {
                                            Console.WriteLine("\t\t\t\tName: {0, 20} Size: {1, 3} Complexity: {2, 3}", func.functionName, func.functionName, func.functionComplexity);
                                        }
                                    }
                                }
                            }
