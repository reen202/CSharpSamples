        ...
        public static AnalyzerOutput doAnalysis(InputParam inputParam)
        {
            ...
            if(!inputParam.relations)
            {
                ...
                foreach (object file in files)
                {
                    ...
                    {
                        Console.Write("\n  {0,10}, {1,25}, {2,5}, {3,5}, {4, 5}, {5, 5}", e.type, e.name, e.begin, e.end, e.lineCount, e.scope);
                    }*/
            ...
            else
            {
                ...
                foreach (object file in files)
                {
                    ...
                    foreach (Elem e in rep.locations)
                    {
                        Console.Write("\n  {0,10}, {1,25}, {2,5}, {3,5}, {4, 5}, {5, 5}, {6, 5}", e.type, e.name, e.begin, e.end, e.lineCount, e.scope, e.relClass);
                    }
                    */
                ...
                //Console.WriteLine("\n\n");
                // Complexity complexity = new Complexity();
                //analyzerOutput.complexity = complexity;
